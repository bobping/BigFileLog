...
import com.ztesoft.handler.FileLogReadHandler;
...
//									+ "_Thread_Group")));
			...
			if (severType.equals(AsyncSocketServer.WRITER_SEVER)) {
				handler = new FileLogWriteHandler(asyncServerSocketChannel);
			} else if (severType.equals(AsyncSocketServer.READER_SEVER)) {
				handler = new FileLogReadHandler(asyncServerSocketChannel);
			}
